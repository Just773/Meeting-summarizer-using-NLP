...
class Test():
    ...
    def __init__(self):
        ...
        self.button1 = tk.Button(self.root, text='Start', bd=5, bg='white', fg='#272358', font=('times', 13, 'bold'),
                                 width=20, command=self.startrecording)
        self.button2 = tk.Button(self.root, text='Stop', bd=5, bg='white', fg='#272358', font=('times', 13, 'bold'),
                                 width=20, command=self.stoprecording)
...
def Summary():
    ...
    summary_output_path = 'summary.doc'  # Update this with the correct path

    # Write the generated summary to the specified path
    with open(summary_output_path, 'w') as out:
        out.write(summary_text)

    print("\nGenerated Summary: ", summary_text)
    print("Summary Generated")
    Encryption()  # Assuming Encryption() performs encryption for the summary file
...
def sendMail():
    SenderAddress = "nixonnam1020@gmail.com"
    password = "rpfptxcofxpognrx"
    ...
    body = "From here you can decrypt the Encrypted Summary. Link --> " \
           "https://drive.google.com/file/d/1sfF0D68JWZjBIUKRFkcan4T6FN2DjOao/view?usp=sharing "
...
def messageWindow():
    ...
    msgLabel = tk.Label(msgwindow, text="The summary has been sent! ", bg='#272358', fg='white',
                        font=('Times', 14, 'bold')).place(x=2, y=70)
    msgButton = tk.Button(msgwindow, text="Ok", bd=8, bg='white', fg='#272358', font=('Times', 14, 'bold'), width=8,
                          command=msgwindow.destroy).place(x=75, y=130)
...
btnRecord = tk.Button(text="Record", bd=10, bg='white', fg='#272358', font=buttonFont, height=1, width=20,
                      command=Test).place(x=550, y=250)
btnBrowse = tk.Button(text="Browse", bd=10, bg='white', fg='#272358', font=buttonFont, width=20,
                      command=BrowseFile).place(x=550, y=400)
